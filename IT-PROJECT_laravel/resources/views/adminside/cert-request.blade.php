...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="menu">
            ...
            <a href="{{ route('admin.cert-request') }}" class="menu-item  active">
                <img src="{{ asset('images/whitecert-icon.png') }}" alt=""> Certification Request
            </a>
            <a href="{{ route('admin.req-management') }}" class="menu-item">
                <img src="{{ asset('images/req-icon.png') }}" alt=""> Request Management
            </a>
            <a href="{{ route('admin.req-history') }}" class="menu-item">
                <img src="{{ asset('images/req-icon.png') }}" alt=""> Request History
            </a>
            <a href="{{ route('admin.bill-pay') }}" class="menu-item">
                <img src="{{ asset('images/billicon.png') }}" alt="">Billings and Payment
            </a>
            <a href="{{ route('admin.form-fees') }}" class="menu-item">
            ...
            <div class="table-container">
                <table id="requestsTable">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" style="text-align:center;">No certification requests found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
