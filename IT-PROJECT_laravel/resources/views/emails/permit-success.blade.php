...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Your Permit Has Been Generated</h2>
            ...
            <p>Your application <strong>{{ $transaction->payment_reference }}</strong> has been approved and your
                permit has been generated. Below are the details:</p>
            ...
            <div class="details-box">
                ...
                <ul>
                    <li><strong>Name:</strong> {{ $form->applicant }}</li>
                    <li><strong>Permit Type:</strong> {{ strtoupper($permit->permit_type_display ?? '—') }}</li>
                    <li><strong>Radio Service:</strong> {{ strtoupper($permit->radio_service ?? '—') }}</li>
                    <li><strong>Application Type:</strong> {{ strtoupper($permit->application_type ?? '—') }}</li>
                    <li><strong>Intended Use:</strong> {{ strtoupper($permit->intended_use ?? '—') }}</li>
                    <li><strong>Issuance Date:</strong> {{ $permit->issuance_date ?? '—' }}</li>
            ...
            <div class="success-banner">
                ...
                <p>
                    Your permit has been successfully generated and is attached to this email.
