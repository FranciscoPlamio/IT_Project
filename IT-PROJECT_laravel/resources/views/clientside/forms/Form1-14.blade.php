                        ...
                        <fieldset class="fieldset-compact">
                            ...
                            <div class="form-field" data-require-one="input[type=checkbox]">
                                ...
                                <input class="form1-01-input" type="text" name="co_government_details"
                                    placeholder="Details">
                                <label><input type="checkbox" name="nature_service" value="cp_public"> CP (PUBLIC
                            ...
                            <div class="form-grid-2" data-require-one="input[type=checkbox]">
                                ...
                                <div class="form-field">
                                    ...
                                    <input class="form1-01-input" type="text" name="tc_units"
                                        placeholder="Units">
                                    <label><input type="checkbox" name="station_class" value="others"> OTHERS,
                                        specify</label>
                    ...
                    <section class="step-content" id="step-particulars">
                        <fieldset>
                            ...
                            <div class="form-grid-3">
                                ...
                                <div class="form-field"><label class="form-label">Proposed Freq.</label><input
                                        class="form1-01-input" type="text" name="proposed_freq"></div>
