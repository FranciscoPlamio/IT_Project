    ...
    <header>
        <div class="top-bar">
            ...
            <div class="title">
                ...
                <h1>National Telecommunication Commission<br><span>ONE STOP PUBLIC ASSISTANCE
                        CENTER</span><br><span>Leonard Wood Road, Pacdal, Baguio City 2600</span><br><span>Telephone
                        Number: (074) 442-9342/304-4876</span></h1>
            </div>
            ...
            <div class="form-layout">
                <aside class="steps-sidebar">
                    ...
                    <ul class="steps-list" id="stepsList25text">
                        ...
                        <li class="step-item" data-step="complaint">Complaint Against <span
                                class="step-status">&nbsp;</span></li>
                        <li class="step-item" data-step="undertaking">Undertaking <span
                                class="step-status">&nbsp;</span></li>
                ...
                <div>
                    <section class="step-content active" id="step-affiant">
                        <fieldset>
                            ...
                            <div class="inline-text-container">
                                I, <input class="inline-input-name" type="text" name="affiant_name" required>, of
                                legal age, <input class="inline-input-civil-status" type="text" name="civil_status"
                                    placeholder="single/married">, Filipino, with residence at <input
                                    class="inline-input-address" type="text" name="residence_address" required> after
                                ...
                                <table style="width:100%;border-collapse:collapse;margin-top:12px;">
                                    <thead>
                                        <tr style="background-color:#f5f5f5;">
                                            <th
                                                style="border:1px solid #ddd;padding:8px;text-align:left;font-size:0.97rem;width:25%;">
                                                Date/Time Received</th>
                                            <th
                                                style="border:1px solid #ddd;padding:8px;text-align:left;font-size:0.97rem;width:25%;">
                                                Cell Phone No.</th>
                                            <th
                                                style="border:1px solid #ddd;padding:8px;text-align:left;font-size:0.97rem;width:50%;">
                                                MESSAGE</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td style="border:1px solid #ddd;padding:8px;">
                                                <input class="form1-01-input" type="datetime-local"
                                                    name="message1_datetime"
                                                    style="border:none;width:100%;padding:4px;">
                                            </td>
                                            <td style="border:1px solid #ddd;padding:8px;">
                                                <input class="form1-01-input" type="text" name="message1_phone"
                                                    style="border:none;width:100%;padding:4px;"
                                                    placeholder="Cell phone number">
                                            </td>
                                            <td style="border:1px solid #ddd;padding:8px;">
                                                <textarea class="form1-01-input" name="message1_content" rows="3"
                                                    style="border:none;width:100%;padding:4px;resize:vertical;" placeholder="Message content"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="border:1px solid #ddd;padding:8px;">
                                            ...
                                            <td style="border:1px solid #ddd;padding:8px;">
                                                <input class="form1-01-input" type="text" name="message2_phone"
                                                    style="border:none;width:100%;padding:4px;"
                                                    placeholder="Cell phone number">
                                            </td>
                                            <td style="border:1px solid #ddd;padding:8px;">
                                                <textarea class="form1-01-input" name="message2_content" rows="3"
                                                    style="border:none;width:100%;padding:4px;resize:vertical;" placeholder="Message content"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="border:1px solid #ddd;padding:8px;">
                                                <input class="form1-01-input" type="text" name="message3_phone"
                                                    style="border:none;width:100%;padding:4px;"
                                                    placeholder="Cell phone number">
                                            </td>
                                            <td style="border:1px solid #ddd;padding:8px;">
                                                <textarea class="form1-01-input" name="message3_content" rows="3"
                                                    style="border:none;width:100%;padding:4px;resize:vertical;" placeholder="Message content"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="border:1px solid #ddd;padding:8px;">
                                                <input class="form1-01-input" type="text" name="message4_phone"
                                                    style="border:none;width:100%;padding:4px;"
                                                    placeholder="Cell phone number">
                                            </td>
                                            <td style="border:1px solid #ddd;padding:8px;">
                                                <textarea class="form1-01-input" name="message4_content" rows="3"
                                                    style="border:none;width:100%;padding:4px;resize:vertical;" placeholder="Message content"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="border:1px solid #ddd;padding:8px;">
                                                <input class="form1-01-input" type="text" name="message5_phone"
                                                    style="border:none;width:100%;padding:4px;"
                                                    placeholder="Cell phone number">
                                            </td>
                                            <td style="border:1px solid #ddd;padding:8px;">
                                                <textarea class="form1-01-input" name="message5_content" rows="3"
                                                    style="border:none;width:100%;padding:4px;resize:vertical;" placeholder="Message content"></textarea>
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        <fieldset>
                            ...
                            <div style="font-size:0.97rem;margin-bottom:12px;">
                                In view of the foregoing, I am filing a complaint against <input class="form1-01-input"
                                    type="text" name="complaint_against"
                                    style="display:inline-block;width:300px;margin:0 8px;" required>
                            </div>
                            <div class="step-actions"><button type="button" class="btn-secondary"
                                    data-prev>Back</button><button type="button" class="btn-primary"
                                    data-next>Next</button></div>
                    ...
                    <section class="step-content" id="step-signature">
                        <fieldset>
                            ...
                            <div style="font-size:0.97rem;margin-bottom:12px;">
                                Baguio City, <input class="form1-01-input" type="date" name="complaint_date"
                                    style="display:inline-block;width:150px;margin:0 8px;"> 2021.
                            </div>
                            <div class="form1-01-signature-row">
                                <div class="form1-01-signature-col">
                                    <input class="signature-line-input" type="text" name="affiant_signature"
                                        placeholder="SIGNATURE OVER PRINTED NAME" required />
                                    <label class="form1-01-label" style="margin-top:16px;">Telephone Number: <input
                                            class="form1-01-input" type="text" name="telephone_number"></label>
                                </div>
                            </div>
                            <div style="font-size:0.97rem;margin-top:20px;">
                                Subscribed and sworn to before me this <input class="form1-01-input" type="text"
                                    name="sworn_day" style="display:inline-block;width:80px;margin:0 8px;"> day of
                                <input class="form1-01-input" type="text" name="sworn_month"
                                    style="display:inline-block;width:120px;margin:0 8px;"> 2021.
                            </div>
                            <div style="text-align:center;font-size:1.1rem;font-weight:bold;margin-top:16px;">
                                ADMINISTERING OFFICER
                            </div>
                            <div style="text-align:center;margin-top:8px;">
                                <input class="form1-01-input" type="text" name="administering_officer"
                                    placeholder="ADMINISTERING OFFICER" style="max-width:260px;width:100%;" />
                            </div>
                            <div class="step-actions"><button type="button" class="btn-secondary"
                                    data-prev>Back</button><button class="form1-01-btn" type="button"
                                    id="validateBtn25text">Proceed to Validation</button></div>
                        </fieldset>
                    </section>
                </div>
            </div>
