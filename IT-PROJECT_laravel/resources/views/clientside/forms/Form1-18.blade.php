<x-layout :title="'Application for Dealer/Manufacturer/Service Center/Retailer/Reseller Permit/CPE Supplier Accreditation (Form 1-18)'" :form-header="['formNo' => 'NTC 1-18', 'revisionNo' => '02', 'revisionDate' => '03/31/2023']" :show-navbar="false">
                        ...
                        <fieldset class="fieldset-compact">
                            ...
                            <div class="form-grid-2">
                                <div class="form-field" data-require-one="input[type=checkbox]">
                                    ...
                                    <label><input type="checkbox" name="rce_category" value="radio_transmitter">
                                        Radio Transmitter/Transceiver</label>
                                    <label><input type="checkbox" name="rce_category" value="wdn_indoor"> WDN
                                        Indoor/SRD/RFID</label>
                                    <label><input type="checkbox" name="rce_category" value="manufacturer">
                                        Manufacturer</label>
                                    <label><input type="checkbox" name="rce_category" value="service_center">
                                        Service Center</label>
                                </div>
                                <div class="form-field" data-require-one="input[type=checkbox]">
                                    <div class="form-label">Mobile Phone</div>
                                    <label><input type="checkbox" name="mobile_category" value="dealer_mpdp"> Dealer
                                        (MPDP)</label>
                                    <label><input type="checkbox" name="mobile_category" value="retailer_reseller">
                                        Retailer/Reseller (MPRR)</label>
                                    <label><input type="checkbox" name="mobile_category" value="service_center_mpscp">
                                        Service Center (MPSCP)</label>
                                    <div class="form-label" style="margin-top:12px;">Customer Premises Equipment
                                        (CPE) Supplier Accreditation</div>
                                    <label><input type="checkbox" name="cpe_category" value="cpe_supplier"> CPE
                            ...
                            <div class="form-grid-3">
                                <div class="form-field"><label class="form-label">Type of Entity</label>
                                    <div class="inline-radio">
                                        <label><input type="radio" name="entity_type" value="corporation">
                                            Corporation</label>
                                        <label><input type="radio" name="entity_type"
                                                value="single_proprietorship"> Single Proprietorship</label>
                                        <label><input type="radio" name="entity_type" value="partnership">
                                            Partnership</label>
                                        <label><input type="radio" name="entity_type" value="others">
                                            Others</label>
                                    </div>
                        ...
                        <fieldset>
                            ...
                            <div class="form-grid-2">
                                <div class="form-field">
                                    ...
                                    <label class="form-label">Name</label><input class="form1-01-input"
                                        type="text" name="supervising_engineer_name">
                                    <label class="form-label">PECE/ECE No.</label><input class="form1-01-input"
                                        type="text" name="supervising_engineer_pece">
                                    <label class="form-label">Validity</label><input class="form1-01-input"
                                        type="date" name="supervising_engineer_validity">
                                </div>
                                <div class="form-field">
                                    <div class="form-label">Technician</div>
                                    <label class="form-label">Name</label><input class="form1-01-input"
                                        type="text" name="technician_name">
                                    <label class="form-label">Certificate/ECT No.</label><input class="form1-01-input"
                                        type="text" name="technician_certificate">
                                    <label class="form-label">Validity</label><input class="form1-01-input"
                                        type="date" name="technician_validity">
                                </div>
                            </div>
                            <div class="step-actions"><button type="button" class="btn-secondary"
                                    data-prev>Back</button><button type="button" class="btn-primary"
                    ...
                    <section class="step-content" id="step-declaration">
                        <fieldset>
                            ...
                            <div class="step-actions"><button type="button" class="btn-secondary"
                                    ...
                                    id="validateBtn18">Proceed to Validation</button></div>
                        </fieldset>
                    </section>
                </div>
            </div>
