<x-layout :title="'Issuance of Radio Station License and Permit to Possess (BTS)'">
    <main class="max-w-5xl mx-auto bg-white shadow-md rounded-xl p-6 mt-2">
        ...
        <header class="mb-4 p-1">
            <h1 class="text-2xl font-semibold">
                Issuance of Radio Station License and Permit to Possess (BTS)
            </h1>
        </header>
        ...
        <section class="space-y-4">
            <div>
                <div class="bg-gray-50 rounded-lg p-4 text-gray-700 space-y-2">
                    ...
                    <ul class="list-disc pl-6 space-y-1">
                        <li>
                            Radio Station License (Renewal) of Microwave, VSAT, Public Trunked, BWA, WDN, WLL, and BTS
                            Stations
                        </li>
                        <li>
                            Radio Station License (Modification) of Base Transceiver Stations (BTS)
                        </li>
                        <li>
                            Permit to Possess (for Storage) of BTS radio equipment of Public Telecommunications
                            Entities
                        </li>
                    </ul>
                </div>
            ...
            <div>
                <div class="bg-gray-50 rounded-lg p-4 text-gray-700 space-y-2">
                    <p>
                        The <span class="font-semibold">renewal of a Radio Station License</span> is required from the
                        public telecommunications entity for the continuous operation of an existing radio station.
                    </p>
                    <p>
                        The <span class="font-semibold">modification of a Radio Station License</span> is required from
                        the public telecommunications entity for changes in the particulars indicated in the License.
                    </p>
                    <p>
                        A <span class="font-semibold">Permit to Possess (for Storage)</span> is a written authority
                        issued by the Commission to a public telecommunications entity (PTE) authorizing the holder
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div class="bg-gray-50 rounded-lg p-4 text-gray-700 space-y-2">
                    ...
                    <p>Public Telecommunications Entities (PTEs)</p>
                </div>
            </div>
        </section>
        ...
        <section class="space-y-6">
            <!-- A. Radio Station License (Renewal) -->
            <div x-data="{ open: false }" class="bg-gray-50 rounded-lg p-4 text-gray-700">
                <button @click="open = !open"
                    ...
                    A. Radio Station License (Microwave, VSAT, Public Trunked, BWA, WDN, WLL, BTS) (RENEWAL)
                ...
                <div x-show="open" x-transition class="mt-2 text-gray-700">
                    <ol class="list-decimal pl-6 space-y-1">
                        ...
                        <li>
                            For VSAT, Copy of valid Transponder Lease Agreement (TLA) with any satellite operator
                            <span class="block text-sm text-gray-600">Where to secure: Applicant</span>
                        </li>
                    </ol>

                    <div class="mt-3 flex flex-wrap gap-3 justify-center">
                        <a href="{{ route('forms.show', ['formType' => '1-11', 'category' => 'bts-rsl-renewal']) }}"
            ...
            <!-- B. Radio Station License (Modification of BTS) -->
            <div x-data="{ open: false }" class="bg-gray-50 rounded-lg p-4 text-gray-700">
                <button @click="open = !open"
                    class="w-full text-left flex justify-between items-center font-semibold text-lg">
                    B. Radio Station License (MODIFICATION of BTS)
                ...
                <div x-show="open" x-transition class="mt-2 text-gray-700 space-y-2">
                    <ol class="list-decimal pl-6 space-y-1">
                        ...
                        <li>
                            If modification is due to <span class="font-semibold">Change of Equipment</span>,
                            Photocopy of valid Permit to Purchase/Possess <span class="font-semibold">OR</span> Permit
                            to
                            Possess (for Storage)
                            <span class="block text-sm text-gray-600">Where to secure: Applicant</span>
                        </li>
                    ...
                    <p class="mt-2 text-sm text-gray-600">
                        Note: For other modifications, the Applicant shall apply at the Networks and Facilities
                        Division,
                        Regulation Branch.
                    </p>

                    <div class="mt-3 flex flex-wrap gap-3 justify-center">
                        <a href="{{ route('forms.show', ['formType' => '1-11', 'category' => 'bts-rsl-modification']) }}"
                            class="inline-block bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">
                            Apply using Form 1-11 (Radio Station License – Modification)
                        </a>
                        <a href="{{ route('forms.show', ['formType' => '1-13', 'category' => 'form-d-modification']) }}"
                            class="inline-block bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700 transition">
                            Apply using Form 1-13 (Form D – For Modification)
                        </a>
                    </div>
                </div>
            </div>

            <!-- C. Permit to Possess for Storage (BTS) -->
            <div x-data="{ open: false }" class="bg-gray-50 rounded-lg p-4 text-gray-700">
                <button @click="open = !open"
                    class="w-full text-left flex justify-between items-center font-semibold text-lg">
                    C. Permit to Possess for Storage (BTS)
                ...
                <div x-show="open" x-transition class="mt-2 text-gray-700">
                    ...
                    <div class="mt-3 flex flex-wrap gap-3 justify-center">
                        <a href="{{ route('forms.show', ['formType' => '1-09', 'category' => 'bts-storage-permit']) }}"
                            class="inline-block bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">
