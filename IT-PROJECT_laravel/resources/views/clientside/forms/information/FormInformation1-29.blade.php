        ...
        <section class="space-y-6">
                ...
                <ol class="list-decimal pl-6 space-y-1">
                    <li>
                        ...
                        <p class="mt-1 text-xs text-gray-600">
                            Note: The Affidavit of Loss must indicate the mobile number of the phone and/or the SIM to
                            be blocked.
                        </p>
                    </li>
                    <li>
                        ...
                        <ol class="list-decimal pl-6 mt-1 text-sm space-y-1">
                            ...
                            <li>
                                Certificate of Purchase issued by the Authorized Seller with the Name of the Purchaser,
                                Date of Purchase and IMEI
                            </li>
                            <li>
                                In the absence of 2.1, 2.2 &amp; 2.3: Affidavit (of loss, declaring ownership and
                                providing a reference for blocking such as IMEI and, if available, the Police Blotter)
                            </li>
                        </ol>
                        <span class="block text-sm text-gray-600">
                    ...
                    <li>
                        ...
                        <span class="block text-sm text-gray-600">
                            Where to secure: BIR / Post Office / DFA / SSS / GSIS / PAG‑IBIG / PSA / School / NBI / LTO
                        </span>
                    </li>
                </ol>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg p-4 text-gray-700 space-y-2">
                ...
                <ol class="list-decimal pl-6 space-y-1">
                    ...
                    <li>
                        Photocopy of latest Statement of Account (SOA), Service Contract and/or Document indicating the
