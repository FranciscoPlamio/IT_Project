<x-layout :title="'Issuance of Public Coastal Station License (Renewal)'">
    <main class="max-w-5xl mx-auto bg-white shadow-md rounded-xl p-6 mt-2">
        ...
        <section class="space-y-4">
            ...
            <div>
                <div class="bg-gray-50 rounded-lg p-4 text-gray-700">
                    <p>
                        The <span class="font-semibold">renewal of Public Coastal Station License</span> is required for
                        the continuous operation of public coastal stations in the Maritime Service.
                    </p>
                </div>
            </div>
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div class="bg-gray-50 rounded-lg p-4 text-gray-700 space-y-2">
                    ...
                    <p>
                        Public Telecommunications Entities (PTEs) authorized to engage in public maritime communications
                        service.
                    </p>
                </div>
            </div>
        ...
        <section class="space-y-6">
            <!-- Public Coastal Station License (Renewal) -->
            <div class="bg-gray-50 rounded-lg p-4 text-gray-700 space-y-2">
                <div class="font-semibold text-lg">Public Coastal Station License (RENEWAL)</div>
