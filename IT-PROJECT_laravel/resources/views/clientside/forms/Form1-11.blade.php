...
<body>
  ...
  <main>
    <form class="form1-01-container" id="form111">
      ...
      <div class="form1-01-warning"><div class="form1-01-warning-title">WARNING:</div> Ensure that all details in identification fields are correct. Incorrect entries may require a new appointment.<div class="form1-01-agree"><label><input type="checkbox"/> I agree / Malinaw sa akin</label></div></div>
      ...
      <div class="form-layout">
        <aside class="steps-sidebar">
          ...
          <ul class="steps-list" id="stepsList11">
            ...
            <li class="step-item" data-step="station">Class of Station <span class="step-status">&nbsp;</span></li>
            <li class="step-item" data-step="personal">Applicant Information <span class="step-status">&nbsp;</span></li>
            <li class="step-item" data-step="particulars">Station/Equipment/Antenna <span class="step-status">&nbsp;</span></li>
        ...
        <div>
            ...
            <fieldset class="fieldset-compact">
              ...
              <div class="form-grid-2">
                <div class="form-field" data-require-one="input[type=checkbox]">
                  ...
                  <label><input type="checkbox" name="application_type" value="modification"> MODIFICATION due to (USE FORM B)</label>
                ...
                <div class="form-field">
                  ...
                  <input class="form1-01-input" type="text" name="years" placeholder="e.g., 2" required>
            ...
            <fieldset class="fieldset-compact">
              ...
              <div class="form-grid-2" data-require-one="input[type=checkbox]">
                ...
                <div class="form-field">
                  ...
                  <input class="form1-01-input" type="text" name="others_specify" placeholder="Specify">
                </div>
              </div>
          ...
          <section class="step-content" id="step-station">
            <fieldset class="fieldset-compact">
              ...
              <div class="form-grid-2" data-require-one="input[type=checkbox]">
                ...
                <div class="form-field">
                  <label><input type="checkbox" name="station_class" value="fc"> FC</label>
          ...
          <section class="step-content" id="step-personal">
            <fieldset>
              ...
              <div class="form-grid-3">
                ...
                <div class="form-field"><label class="form-label">Contact No.</label><input class="form1-01-input" type="text" name="contact_number" required></div>
          ...
          <section class="step-content" id="step-particulars">
            <fieldset>
              ...
              <div class="form-grid-2">
                ...
                <div class="form-field"><label class="form-label">Assigned Freq.</label><input class="form1-01-input" type="text" name="assigned_freq"></div>
              </div>
              <div class="form-grid-3">
                <div class="form-field"><label class="form-label">BW & Emission</label><input class="form1-01-input" type="text" name="bw_emission"></div>
                <div class="form-field"><label class="form-label">Configuration</label><input class="form1-01-input" type="text" name="configuration"></div>
              ...
              <div class="form-grid-3">
                ...
                <div class="form-field"><label class="form-label">RSL No.</label><input class="form1-01-input" type="text" name="rsl_no"></div>
              ...
              <div class="form-grid-3">
                <div class="form-field"><label class="form-label">Antenna Type</label><input class="form1-01-input" type="text" name="antenna_type"></div>
                <div class="form-field"><label class="form-label">Height (m)</label><input class="form1-01-input" type="text" name="antenna_height"></div>
                <div class="form-field"><label class="form-label">Gain (dB)</label><input class="form1-01-input" type="text" name="antenna_gain"></div>
              </div>
              <div class="form-grid-3">
                <div class="form-field"><label class="form-label">Directivity</label><input class="form1-01-input" type="text" name="antenna_directivity"></div>
                <div class="form-field"><label class="form-label">Polarization</label><input class="form1-01-input" type="text" name="antenna_polarization"></div>
                <div class="form-field"><label class="form-label">Beamwidth</label><input class="form1-01-input" type="text" name="antenna_beamwidth"></div>
              </div>
              <div class="form-grid-2">
                <div class="form-field"><label class="form-label">Diameter (for microwave)</label><input class="form1-01-input" type="text" name="antenna_diameter"></div>
              </div>
              <div class="step-actions"><button type="button" class="btn-secondary" data-prev>Back</button><button type="button" class="btn-primary" data-next>Next</button></div>
            </fieldset>
          </section>
          ...
          <section class="step-content" id="step-declaration">
            <fieldset>
              ...
              <div class="step-actions"><button type="button" class="btn-secondary" data-prev>Back</button><button class="form1-01-btn" type="button" id="validateBtn11">Proceed to Validation</button></div>
            </fieldset>
          </section>
        </div>
      </div>
    </form>
    <a id="validationLink11" href="{{ route('forms.1-01.validation') }}" style="display:none;">Validation</a>
    <script>
      (function() {
        ...
        if (validateBtn) {
          validateBtn.addEventListener('click', () => {
            ...
            if (validationLink11) {
              window.location.href = validationLink11.href;
            }
          });
        }
