                            ...
                            <div class="form-grid-2" data-require-one="input[type=checkbox]">
                                <div class="form-field">
                                    ...
                                    <label><input type="checkbox" name="radio_service" value="aeronautical">
                                        AERONAUTICAL</label>
                                    <label><input type="checkbox" name="radio_service" value="maritime"> MARITIME
                                        (Public/Private Coastal)</label>
                                </div>
                                <div class="form-field">
                                    <label><input type="checkbox" name="radio_service" value="broadcast">
                                        BROADCAST</label>
                                    <label><input type="checkbox" name="radio_service" value="others"> OTHERS,
                                        specify</label>
                    ...
                    <section class="step-content" id="step-personal">
                        <fieldset>
                            ...
                            <div class="form-grid-3">
                                ...
                                <div class="form-field"><label class="form-label">Contact No.</label><input
                        ...
                        <fieldset>
                            ...
                            <div class="form-grid-3">
                                <div class="form-field"><label class="form-label">Exact Location</label><input
                                        class="form1-01-input" type="text" name="exact_location"></div>
                                <div class="form-field"><label class="form-label">Long (deg-min-sec)</label><input
                                        class="form1-01-input" type="text" name="longitude"></div>
                                <div class="form-field"><label class="form-label">Lat (deg-min-sec)</label><input
                                        class="form1-01-input" type="text" name="latitude"></div>
                            </div>
                            <div class="form-grid-2">
                                ...
                                <div class="form-field"><label class="form-label">Assigned Freq.</label><input
                                        class="form1-01-input" type="text" name="assigned_freq"></div>
                            </div>
                            <div class="form-grid-3">
                                <div class="form-field"><label class="form-label">BW & Emission</label><input
                                        class="form1-01-input" type="text" name="bw_emission"></div>
                                <div class="form-field"><label class="form-label">Configuration</label><input
                                        class="form1-01-input" type="text" name="configuration"></div>
                                <div class="form-field"><label class="form-label">Data Rate</label><input
                                        class="form1-01-input" type="text" name="data_rate"></div>
                            </div>
                            <div class="form-grid-3">
                                <div class="form-field"><label class="form-label">Call Sign</label><input
                                        class="form1-01-input" type="text" name="call_sign"></div>
                                <div class="form-field"><label class="form-label">RSL No.</label><input
                                        class="form1-01-input" type="text" name="rsl_no"></div>
                            ...
                            <div class="form-grid-2">
                                ...
                                <div class="form-field"><label class="form-label">Others, specify</label><input
                                        class="form1-01-input" type="text" name="others_station"></div>
                            </div>
                            <div class="form-grid-3">
                                <div class="form-field"><label class="form-label">Antenna Type</label><input
                                        class="form1-01-input" type="text" name="antenna_type"></div>
                                <div class="form-field"><label class="form-label">Height (m)</label><input
                                        class="form1-01-input" type="text" name="antenna_height"></div>
                                <div class="form-field"><label class="form-label">Gain (dB)</label><input
                                        class="form1-01-input" type="text" name="antenna_gain"></div>
                            </div>
                            <div class="form-grid-3">
                                <div class="form-field"><label class="form-label">Directivity</label><input
                                        class="form1-01-input" type="text" name="antenna_directivity"></div>
                                <div class="form-field"><label class="form-label">Polarization</label><input
                                        class="form1-01-input" type="text" name="antenna_polarization"></div>
                                <div class="form-field"><label class="form-label">Beamwidth</label><input
                                        class="form1-01-input" type="text" name="antenna_beamwidth"></div>
                            </div>
                            <div class="form-grid-2">
                                <div class="form-field"><label class="form-label">Diameter (for
                                        microwave)</label><input class="form1-01-input" type="text"
                                        name="antenna_diameter"></div>
                            </div>
                            <div class="step-actions"><button type="button" class="btn-secondary"
                                    data-prev>Back</button><button type="button" class="btn-primary"
                                    data-next>Next</button></div>
                    ...
                    <section class="step-content" id="step-declaration">
                        <fieldset>
                            ...
                            <div class="form1-01-declaration">I hereby declare that all the above entries are true
                                ...
                                serve as a valid ground for the denial of this application and/or revocation of the
                                permit/certificate/license issued. Further, I am freely giving full consent for the
                                collection and processing of personal information in accordance with Republic Act
                                No. 10173, Data Privacy Act of 2012.</div>
                            ...
                            <div class="step-actions"><button type="button" class="btn-secondary"
                                    ...
                                    id="validateBtn11">Proceed to Validation</button></div>
                        </fieldset>
                    </section>
                </div>
            </div>
