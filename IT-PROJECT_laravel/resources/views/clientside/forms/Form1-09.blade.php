...
<body>
  ...
  <main>
    <form class="form1-01-container" id="form109">
      ...
      <div class="form1-01-warning"><div class="form1-01-warning-title">WARNING:</div> Ensure that all details in critical identification fields are correct. Incorrect entries may require setting a new appointment.<div class="form1-01-agree"><label><input type="checkbox"/> I agree / Malinaw sa akin</label></div></div>
      ...
      <div class="form-layout">
        <aside class="steps-sidebar">
          ...
          <ul class="steps-list" id="stepsList09">
            ...
            <li class="step-item" data-step="station">Station/Equipment Details <span class="step-status">&nbsp;</span></li>
            <li class="step-item" data-step="source">Source of Equipment <span class="step-status">&nbsp;</span></li>
            <li class="step-item" data-step="intended">Intended Use <span class="step-status">&nbsp;</span></li>
        ...
        <div>
          <section class="step-content active" id="step-personal">
            <fieldset>
              ...
              <div class="form-grid-3">
                ...
                <div class="form-field"><label class="form-label">CPC/CPCN/PA/RSL No.</label><input class="form1-01-input" type="text" name="cpc_cpcn_pa_rsl_no"></div>
          ...
          <section class="step-content" id="step-application">
            ...
            <label><input type="checkbox" name="nature_service" value="cp_public"> CP (PUBLIC CORRESPONDENCE)</label>
                ...
                <div class="form-field" data-require-one="input[type=checkbox]">
                  ...
                  <label><input type="checkbox" name="station_class" value="rt"> RT (Radio Telephone)</label>
                  <input class="form1-01-input" type="text" name="rt_units" placeholder="Units">
                  <label><input type="checkbox" name="station_class" value="fx"> FX (Fixed)</label>
                  <input class="form1-01-input" type="text" name="fx_units" placeholder="Units">
                  <label><input type="checkbox" name="station_class" value="fb"> FB (Fixed Base)</label>
                  <input class="form1-01-input" type="text" name="fb_units" placeholder="Units">
                  <label><input type="checkbox" name="station_class" value="ml"> ML (Mobile Land)</label>
                  <input class="form1-01-input" type="text" name="ml_units" placeholder="Units">
                  <label><input type="checkbox" name="station_class" value="p"> P (Portable)</label>
                  <input class="form1-01-input" type="text" name="p_units" placeholder="Units">
                  <label><input type="checkbox" name="station_class" value="bc"> BC (Broadcast)</label>
                  <input class="form1-01-input" type="text" name="bc_units" placeholder="Units">
                  <label><input type="checkbox" name="station_class" value="fc"> FC (Fixed Commercial)</label>
                  <input class="form1-01-input" type="text" name="fc_units" placeholder="Units">
                  <label><input type="checkbox" name="station_class" value="fa"> FA (Fixed Aeronautical)</label>
                  <input class="form1-01-input" type="text" name="fa_units" placeholder="Units">
                  <label><input type="checkbox" name="station_class" value="ma"> MA (Mobile Aeronautical)</label>
                  <input class="form1-01-input" type="text" name="ma_units" placeholder="Units">
                  <label><input type="checkbox" name="station_class" value="tc"> TC (Temporary Commercial)</label>
                  <input class="form1-01-input" type="text" name="tc_units" placeholder="Units">
                  <label><input type="checkbox" name="station_class" value="others_station"> OTHERS, specify</label>
          ...
          <section class="step-content" id="step-station">
            <fieldset class="fieldset-compact">
              ...
              <div class="form-grid-3">
                <div class="form-field"><label class="form-label">Exact Location</label><input class="form1-01-input" type="text" name="exact_location" required></div>
              ...
              <div class="form-grid-2">
                ...
                <div class="form-field"><label class="form-label">Frequency</label><input class="form1-01-input" type="text" name="frequency"></div>
          </div>
              <div class="form-grid-2">
              ...
              <div class="form-grid-3">
                <div class="form-field"><label class="form-label">Bandwidth & Emission</label><input class="form1-01-input" type="text" name="bandwidth_emission"></div>
          ...
          <section class="step-content" id="step-source">
            <fieldset class="fieldset-compact">
              ...
              <div class="form-grid-2">
                <div class="form-field"><label class="form-label">Name of Dealer</label><input class="form1-01-input" type="text" name="dealer_name"></div>
                <div class="form-field"><label class="form-label">Authorized Seller/Buyer</label><input class="form1-01-input" type="text" name="authorized_seller_buyer"></div>
          </div>
              <div class="form-grid-2">
                <div class="form-field"><label class="form-label">OR/Invoice No.</label><input class="form1-01-input" type="text" name="or_invoice_no"></div>
                <div class="form-field"><label class="form-label">Permit/RSL No.</label><input class="form1-01-input" type="text" name="permit_rsl_no"></div>
          </div>
              <div class="step-actions"><button type="button" class="btn-secondary" data-prev>Back</button><button type="button" class="btn-primary" data-next>Next</button></div>
      </fieldset>
          </section>
          ...
          <section class="step-content" id="step-intended">
            ...
            <label><input type="checkbox" name="intended_use" value="additional_equipment"> Additional Equipment</label>
                <label><input type="checkbox" name="intended_use" value="storage"> Storage at:</label>
                <input class="form1-01-input" type="text" name="storage_location" placeholder="Location">
                <label><input type="checkbox" name="intended_use" value="others_use"> Others, specify</label>
                <input class="form1-01-input" type="text" name="others_use_specify" placeholder="Specify">
          </div>
              <div class="step-actions"><button type="button" class="btn-secondary" data-prev>Back</button><button type="button" class="btn-primary" data-next>Next</button></div>
      </fieldset>
          </section>
        ...
        <div class="form1-01-signature-row">
          ...
          <div class="form1-01-signature-col" style="border:1px dashed #aaa;padding:12px 8px;min-width:180px;">
            ...
            <div style="font-size:0.97rem;margin-bottom:6px;">Collecting Officer</div>
              ...
              <div class="step-actions"><button type="button" class="btn-secondary" data-prev>Back</button><button class="form1-01-btn" type="button" id="validateBtn09">Proceed to Validation</button></div>
      </fieldset>
          </section>
        </div>
      </div>
    </form>
    <a id="validationLink09" href="{{ route('forms.1-01.validation') }}" style="display:none;">Validation</a>
    <script>
      (function() {
