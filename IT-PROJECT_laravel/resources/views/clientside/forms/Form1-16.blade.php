      ...
      <div class="form-layout">
        <aside class="steps-sidebar">
          ...
          <ul class="steps-list" id="stepsList16">
            <li class="step-item active" data-step="transport">Transport Details <span class="step-status">&nbsp;</span></li>
            <li class="step-item" data-step="personal">Applicant Information <span class="step-status">&nbsp;</span></li>
            <li class="step-item" data-step="equipment">Proposed Equipment <span class="step-status">&nbsp;</span></li>
        ...
        <div>
          <section class="step-content active" id="step-transport">
            <fieldset class="fieldset-compact">
              ...
              <div class="form-grid-3">
                <div class="form-field"><label class="form-label">Place of Origin</label><input class="form1-01-input" type="text" name="place_of_origin" required></div>
                <div class="form-field"><label class="form-label">Destination</label><input class="form1-01-input" type="text" name="destination" required></div>
                <div class="form-field"><label class="form-label">Purpose</label><input class="form1-01-input" type="text" name="purpose" required></div>
              </div>
          ...
          <section class="step-content" id="step-ntc">
            <fieldset>
              ...
              <div class="form-grid-2">
                ...
                <div class="form-field"><label class="form-label">Date Issued</label><input class="form1-01-input" type="date" name="date_issued"></div>
              </div>
              <div class="form-grid-2">
                <div class="form-field"><label class="form-label">OR No.</label><input class="form1-01-input" type="text" name="or_no"></div>
                <div class="form-field"><label class="form-label">OR Date</label><input class="form1-01-input" type="date" name="or_date"></div>
              </div>
              <div class="form-grid-2">
                <div class="form-field"><label class="form-label">Amount</label><input class="form1-01-input" type="text" name="or_amount"></div>
                <div class="form-field"><label class="form-label">FOR THE COMMISSION</label><input class="form1-01-input" type="text" name="for_commission_signature"></div>
              </div>
              <div style="font-size:0.97rem;margin-top:12px;color:#666;">This PERMIT shall be valid for a period of fifteen (15) days from the date of issuance. Note: This PERMIT is valid only when the payment of the required fees is included.</div>
              <div class="step-actions"><button type="button" class="btn-secondary" data-prev>Back</button><button type="button" class="btn-primary" data-next>Next</button></div>
            </fieldset>
          </section>
          ...
          <section class="step-content" id="step-declaration">
            <fieldset>
              ...
              <div class="step-actions"><button type="button" class="btn-secondary" data-prev>Back</button><button class="form1-01-btn" type="button" id="validateBtn16">Proceed to Validation</button></div>
            </fieldset>
          </section>
        </div>
      </div>
